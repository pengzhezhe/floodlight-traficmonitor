...
CREATE TABLE `device`  (
  ...
  `mac_address` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '设备mac地址，16进制',
...
CREATE TABLE `rule`  (
  ...
  `action` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'deny' COMMENT '操作',
...
CREATE TABLE `user`  (
  ...
  `password` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '密码',
